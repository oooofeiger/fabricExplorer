...
import { Form, Radio, Button, Modal, Icon, Input, Select, Card, Tooltip } from 'antd';
      ...
      return (
        <div className={styles.cardTitle}>
          ...
          <FormItem
            ...
            validateStatus={
              policyStatus
                ? policyStatus[`policy${list}`]
                  ? policyStatus[`policy${list}`]['status']
                  : ''
                : ''
            }
            help={
    ...
    const formItems = keys.map((k, index) => {
      ...
      return (
        <Card
          ...
          extra={
            <a onClick={() => this.remove(k)} href="javascript:;">
              删除
            </a>
          }
          ...
          {childKeys.map((itme, i) => {
            return (
              <div key={i}>
                ...
                <FormItem label="签名策略" className={styles.signed}>
      ...
      >
        <Form className={styles.form}>
          ...
          <FormItem
            ...
            hasFeedback
            help={
              policyStatus ? (policyStatus['policy'] ? policyStatus['policy']['help'] : '') : ''
            }
            validateStatus={
              policyStatus ? (policyStatus['policy'] ? policyStatus['policy']['status'] : '') : ''
            }
          >
