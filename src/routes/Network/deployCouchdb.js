...
handleSubmit = () => {
    ...
    form.validateFields((err, values)=>{
        if(!err){
            console.log('deployCouchdb',values);
            dispatch({
                ...
                payload: {
                    ...
                    name: values.name_,
                    containerName: values.containerName_,
                    imageVersion: values.imageVersion_,
                    requestPort: values.requestPort_
                }
            })
        }
    })
